...
- **Timeout & graceful termination**
  - Silence timeout: 5 minutes (kills if stdout is idle)
  - Hard timeout: 1 hour
...
| `PI_SUBAGENT_SILENCE_TIMEOUT_MS` | `300000` (5 min) | Max allowed idle time on stdout before the subagent is killed. |
